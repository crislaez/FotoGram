...
class Nav extends React.Component{
    ...
    render(){
        ...
        return(
            <nav>
                <button id='bMenu' className='bIzquierda' onClick={this.props.functionSidebar}><FontAwesomeIcon icon={faBars}></FontAwesomeIcon></button>
                <input id='bVerTodo'  className='bIzquierda' type='button' value='VER TODO' onClick={this.props.handleClick}></input>
                {
                    this.props.ventanaPerfiles
                    ?
                    <input id='bPerfil' type='button' className='bIzquierda' value='PERFIL' onClick={this.props.handleClick}></input>
                    :
